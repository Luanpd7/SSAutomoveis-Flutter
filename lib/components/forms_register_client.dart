      ...
      return Center(
        ...
        child: Column(
          ...
          children: [
              ...
              FormText(label: 'CNPJ', controller: formRegisterProvider.cnpjController),
            
       
              FormText(label: 'Razão Social', controller: formRegisterProvider.razaoSocialController,),
      
               FormText(label: 'Telefone', controller: formRegisterProvider.telefoneController,),
